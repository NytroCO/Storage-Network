...
public class StorageNetworkCapabilities {
    ...
    public static final Capability<IConnectableLink> CONNECTABLE_ITEM_STORAGE_CAPABILITY = null;
    @CapabilityInject(IConnectable.class)
    public static final Capability<IConnectable> CONNECTABLE_CAPABILITY = null;
    @CapabilityInject(IConnectableItemAutoIO.class)
    public static final Capability<IConnectableItemAutoIO> CONNECTABLE_AUTO_IO = null;
