...
public abstract class AbstractBlockConnectable extends BaseBlock {
    ...
    protected AbstractBlockConnectable(Material materialIn, String registryName) {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        try {
            ...
            setConnections(worldIn, pos, true);
        } catch (Exception e) {
            StorageNetwork.instance.logger.error("StorageNetwork: exception thrown while updating neighbours:", e);
        }
    }

    private void setConnections(World worldIn, BlockPos pos, boolean refresh) {
